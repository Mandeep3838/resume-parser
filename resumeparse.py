    ...
    def calculate_experience(resume_text):
        ...
        while regex_result:
            ...
            try:
                ...
                try:
                    start_date_find.group().strip()
                except:
                    print("came from except")
                    return 0
                ...
                try:
                    ...
                    if isinstance(start_date_find.group().strip(), str):
                        start_year_result = [i for i in start_date_find.group().strip() if i.isdigit()]
                        start_year_result = "".join(start_year_result)
                ...
                if date_range.lower().find('present') != -1 or date_range.lower().find('current') != -1:
                    ...
                    try:
                        ...
                        if isinstance(end_date_find.group().strip(), str):
                            end_year_result = [i for i in end_date_find.group().strip() if i.isdigit()]
                            end_year_result = "".join(end_year_result)
                    ...
                    try:
                        ...
                        if isinstance(end_year_result, str):
                            end_year_result = [i for i in end_year_result if i.isdigit()]
                            end_year_result = "".join(end_year_result)
                        end_year_result = int(correct_year(end_year_result))                    
